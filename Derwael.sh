...
cdo chname,__xarray_dataarray_variable__,bedrock DerwaelNewBedrock.nc  DerwaelNewBedrock2.nc

cdo merge DerwaelNewBedrock2.nc Derwael_surface2.nc Derwael_thickness.nc Derwael_base.nc Derwael_bed.nc Derwael_mask.nc Derwael_vx2.nc Derwael_vy2.nc Derwael.nc
